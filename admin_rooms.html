    ...
    <div id="Admin_room_details">
        <div id="admin_dashboard">
            ...
            <ul id="list">
                ...
                <li class="list_items"><a class="list_item_link" href="#"><i class="fa fa-square list_icon"></i>Rooms</a></li>
                <li class="list_items"><a class="list_item_link" href="#"><i class="icon ion-person-stalker list_icon"></i>Manage Students</a></li>
                <li class="list_items"><a class="list_item_link" href="Admin_registration.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="list_icon">
