...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $allottedRoom = $_POST['allottedRoom'];
...
$sqls = "INSERT INTO `student_information` (`student_enrollment`, `first_name`, `middle_name`, `last_name`, `contact_No`, `Date_of_Joining`, `gender`, `duration`, `aadhar_no`, `address`, `email`, `allotted_room_no`) VALUES ('$student_enrollment', '$firstname', '$middlename', '$lastname', '$contact_no', current_timestamp(), 'female', '$duration', '$aadhar_no', '$address', '$email', '$allottedRoom')";
...
$sqlrooms = "INSERT INTO `allotted_room_detail` (`allottedRoomID`, `Allotted_room`, `student_enrol_id`, `allottedDATE`) VALUES (NULL, '$allottedRoom', '$student_enrollment', current_timestamp())";
        $resultroos = mysqli_query($conn , $sqlrooms);
        if($resultroos){
           $errh = true ;   
        }
        else {
...
$sqlg = "INSERT INTO `guardian_information` (`guadianID`, `student_ID`, `guardian_name`, `relation_with_guardian`, `guardian_contact`) VALUES (NULL, '$student_enrollment', '$guardian_name', '$relation_with_guardian', '$guadian_contact_no')";
...
$password ="1234";
$err8 = false;
$sql = "INSERT INTO `logintable` (`loginID`,`student_Id` ,  `loginEmail`, `login_password`) VALUES ('','$student_enrollment',' $email' , '$password')";
...
if($errg == true && $errh == true && $errs == true && $err8 == true ){
    ...
    <div id="registration_big_container">
        <div id="admin_dashboard">
            ...
            <ul id="list">
                ...
                <li class="list_items"><a class="list_item_link" href="Admin_registration.php"><svg xmlns="http://www.w3.org/2000/svg"
                            width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="list_icon">
        ...
        <div id="form_details">
            <section class="contact-clean">
                <form method="post">
                    ...
                    <input class="form-control" name="allottedRoom" type="text" placeholder="Room Allotted">
                    <input class="form-control" name="EnrollmentNo" type="text" placeholder="Enrolment No">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="relation_with_guardian"
                            placeholder="Relation With Guardian">
                        <input class="form-control" type="text" name="guardian_contact"
