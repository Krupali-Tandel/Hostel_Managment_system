    ...
    <div id="big_container">
        <div id="admin_dashboard">
            ...
            <ul id="list">
                ...
                <li class="list_items"><a class="list_item_link" href="admin_notice.html"><i
                ...
                <li class="list_items"><a class="list_item_link" href="#"><i class="fa fa-exchange list_icon"></i>Show
                        Complaints</a></li>
                <li class="list_items"><a class="list_item_link" href="#"><i
