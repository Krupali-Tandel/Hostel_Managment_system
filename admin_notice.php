    ...
    <div id="admin_notice_container">
        <div id="admin_dashboard">
            ...
            <ul id="list">
                ...
                <li class="list_items"><a class="list_item_link" href="admin_rooms.html"><i
                            class="fa fa-square list_icon"></i>Rooms</a></li>
                <li class="list_items"><a class="list_item_link" href="#"><i
                            class="icon ion-person-stalker list_icon"></i>Manage Students</a></li>
                <li class="list_items"><a class="list_item_link" href="Admin_registration.html"><svg
            ...
            <section class="newsletter-subscribe">
                <div class="container" id="notice_container">
                    ...
                    <form class="d-flex justify-content-center flex-wrap" method="post">
                        <div class="mb-3"><textarea class="form-control" name="notice"></textarea></div>
                        <div class="mb-3"><button class="btn btn-primary" type="submit"
                                onclick="publishmessage()">Publish</button></div>
                    </form>
                </div>
            </section>
                ...
                if($number_display > 0){
                    while($noticedata = mysqli_fetch_assoc($resultdisplay)){
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">'.$noticedata['Notice_content'] .'</p>
                            <button id="edit" class="btn btn-primary" name="edit" type="button">Edit</button>
